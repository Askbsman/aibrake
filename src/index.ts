...
// shipping it as a public surface would let a partner accidentally wire
// "payment always succeeds" into production policy. Importable from
// `aibrake/payments` for tests; not from `aibrake`.
export {
  X402PaymentGuard,
